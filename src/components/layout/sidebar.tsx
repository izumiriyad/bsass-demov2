...
const EXTRA_ITEMS = [
  ...
  { id: "referral", label: "Referral", bn: "রেফারেল", emoji: "🤝", href: "/referral" },
  ...
  { id: "brands", label: "BSL Network", bn: "নেটওয়ার্ক", emoji: "🧩", href: "/brands" },
  { id: "payments", label: "Payments", bn: "পেমেন্ট", emoji: "💳", href: "/payments" },
  { id: "agents", label: "Agents", bn: "এজেন্ট", emoji: "🧑‍💼", href: "/agents" },
  { id: "viphost", label: "VIP Host", bn: "ভিআইপি হোস্ট", emoji: "🎩", href: "/vip-host" },
  { id: "leaderboard", label: "Leaderboard", bn: "লিডারবোর্ড", emoji: "🏆", href: "/leaderboard" },
  { id: "guide", label: "New Member Guide", bn: "গাইড", emoji: "🧭", href: "/guide" },
  { id: "forum", label: "BSL Forum", bn: "ফোরাম", emoji: "💬", href: "/forum" },
  { id: "help", label: "Help Page", bn: "সহায়তা", emoji: "ℹ️", href: "/help" },
  { id: "winners", label: "Winner Wall", bn: "উইনার", emoji: "💰", href: "/winners" },
  { id: "livechat", label: "Live Chat", bn: "লাইভ চ্যাট", emoji: "💬", href: "/live-chat" },
  { id: "contact", label: "Contact Us", bn: "যোগাযোগ", emoji: "☎️", href: "/support" },
];
